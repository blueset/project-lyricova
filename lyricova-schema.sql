...
CREATE TABLE `Albums` (
  ...
  FULLTEXT KEY `Album_SearchText` (`name`, `sortOrder`)
...
CREATE TABLE `ArtistOfAlbums` (
  ...
  `categories` enum(
    ...
    'Illustrator',
    'Subject'
  ) COLLATE utf8mb4_general_ci DEFAULT 'Nothing',
...
CREATE TABLE `Artists` (
  ...
  FULLTEXT KEY `Artist_SearchText` (`name`, `sortOrder`)
  /*!50100 WITH PARSER `ngram` */
,
  CONSTRAINT `artists_ibfk_1` FOREIGN KEY (`baseVoiceBankId`) REFERENCES `Artists` (`id`) ON DELETE
...
CREATE TABLE `MusicFiles` (
  ...
  KEY `songId` (`songId`),
  KEY `albumId` (`albumId`),
  FULLTEXT KEY `MusicFiles_SearchText` (
    `path`,
    `trackName`,
    `trackSortOrder`,
    `artistName`,
  ...
  /*!50100 WITH PARSER `ngram` */
,
  CONSTRAINT `musicfiles_ibfk_1` FOREIGN KEY (`songId`) REFERENCES `Songs` (`id`) ON DELETE
  SET NULL ON UPDATE CASCADE,
    CONSTRAINT `musicfiles_ibfk_2` FOREIGN KEY (`albumId`) REFERENCES `Albums` (`id`) ON DELETE
  SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 0 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */
;
...
CREATE TABLE `Songs` (
  ...
  FULLTEXT KEY `Song_SearchText` (`name`, `sortOrder`)
  /*!50100 WITH PARSER `ngram` */
,
  CONSTRAINT `songs_ibfk_1` FOREIGN KEY (`originalId`) REFERENCES `Songs` (`id`) ON DELETE
  SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */
;
...
CREATE TABLE `VideoFiles` (
  ...
  `type` enum(
    ...
    'OffVocal',
    'Other'
  ) COLLATE utf8mb4_general_ci DEFAULT 'Other',
  `creationDate` datetime NOT NULL,
  `updatedOn` datetime NOT NULL,
  `deletionDate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
