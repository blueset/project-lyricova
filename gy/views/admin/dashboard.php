		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div class="sortable row-fluid">
					<a class="well span3 top-block" href="<?=site_url('admin/edit_list');?>">
						<h1><?=$this->post_model->get_post_number()?></h1>
						<div>Posts published</div>
					</a>	
	
					<a class="well span3 top-block" href="<?=site_url('admin/image');?>">
						<h1><?=$this->imggen_model->get_image_number()?></h1>
						<div>Images generated</div>
					</a>

					<a class="well span3 top-block" href="<?=site_url('admin/users_list');?>">
