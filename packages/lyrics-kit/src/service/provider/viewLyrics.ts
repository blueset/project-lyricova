  ...
  public async searchLyrics(
    ...
    try {
      ...
      for (const elm of results) {
        ...
        const timeLength =
          timeLengthVal === undefined || timeLengthVal === "65535"
            ? undefined
            : parseInt(timeLengthVal);
        const rate = parseFloat(elm.attribs.rate),
