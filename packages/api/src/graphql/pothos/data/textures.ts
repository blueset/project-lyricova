/**
 * Texture background catalogue for the `randomTexture` query.
 *
 * Ported verbatim from the pre-migration TypeGraphQL `TextureResolver` so the
 * public site keeps sampling the full set (assets live in
