  ...
  "group/item flex items-start border border-transparent text-sm rounded-md transition-colors [a]:hover:bg-accent/50 [a]:transition-colors duration-100 flex-wrap outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        ...
        muted: "bg-muted/50",
        primary: "bg-primary text-primary-foreground [a]:hover:bg-primary/75",
      },
      size: {
        default: "p-4 gap-4 ",
...
const itemMediaVariants = cva(
  "flex shrink-0 items-center justify-center gap-2 group-has-[[data-slot=item-description]]/item:self-start [&_svg]:pointer-events-none group-has-[[data-slot=item-description]]/item:translate-y-1.5",
  {
    variants: {
      variant: {
        default: "bg-transparent",
        icon: "size-8 rounded-sm [&_svg:not([class*='size-'])]:size-6",
        image:
