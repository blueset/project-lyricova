// @source https://github.com/mui/material-ui/blob/master/packages/mui-material-nextjs/src/v13-pagesRouter/pagesRouterV13Document.tsx

import * as React from "react";
import { AppType } from "next/app";
import { EmotionCache } from "@emotion/react";
import createEmotionServer from "@emotion/server/create-instance";
import { EmotionCacheProviderProps } from "./pagesRouterApp";
import createEmotionCache from "./createCache";
// eslint-disable-next-line @next/next/no-document-import-in-page
import type { DocumentContext, DocumentInitialProps } from "next/document";

type IGetInitialProps = (ctx: DocumentContext) => Promise<DocumentInitialProps>;
...
export function createGetInitialProps(
  plugins: Plugin[],
  documentGetInitialProps: IGetInitialProps
) {
    ...
    [
      {
        enhanceApp: (
          App: React.ComponentType<
            React.ComponentProps<AppType> & EmotionCacheProviderProps
          >
        ) =>
