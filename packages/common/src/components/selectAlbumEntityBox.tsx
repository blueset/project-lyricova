...
export default function SelectAlbumEntityBox<T extends string>({
  ...
  const [vocaDBAutoCompleteOptions, setVocaDBAutoCompleteOptions] = useState<ExtendedAlbum[]>([]);
  ...
  useEffect(() => {
    ...
    _.throttle(async () => {
      ...
      const vocaDBPromise = axios.get<string[]>('https://vocadb.net/api/albums/names', {
        params: {
        ...
        <Grid size={12}>
          <Autocomplete
            ...
            getOptionLabel={option => {
              ...
              if (option === null || (option as ExtendedAlbum).id === null) return '';
