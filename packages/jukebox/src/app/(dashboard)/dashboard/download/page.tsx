...
export default function DownloadMusicFile() {
  ...
  const [chosenSource, setChosenSource] = useNamedState<
    "yt-dlp" | "music-dl" | "mxget" | null
  >(null, "chosenSource");

  const chooseSource = useCallback(
    (sourceName: "yt-dlp" | "music-dl" | "mxget") => () => {
    ...
    <Step>
      ...
      <StepContent>
        ...
        <ButtonRow>
          ...
          <Button variant="outlined" onClick={chooseSource("music-dl")}>
            Music-dl
          </Button>
          <Button variant="outlined" onClick={chooseSource("mxget")}>
            MxGet
          </Button>
        </ButtonRow>
      </StepContent>
  ...
  if (chosenSource === "mxget") {
    return (
      <MxGetDownloadSteps step={step} setStep={setStep} firstStep={firstStep} />
    );
  }
