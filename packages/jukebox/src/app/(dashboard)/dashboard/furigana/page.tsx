  ...
  return (
    <StyledBox>
      ...
      >
        ...
        >
          <DialogTitle id="alert-dialog-title">Batch update</DialogTitle>
          <DialogContent dividers>
            <Stack spacing={2}>
              <Button
                ...
                onClick={async () => {
                  const result = await apolloClient.query<{
                    ...
                    variables: {
                      mapping: data.furiganaMappings
                        .filter((i) => !i.segmentedText || !i.segmentedFurigana)
                        .map((i) => ({ text: i.text, furigana: i.furigana })),
                    },
                  });
                  if (result.data) {
                    setBulkUpdateInput(
              ...
              >
                Predict mapping with dictionary
              </Button>
              <DialogContentText>
                <details>
                  <summary>Batch update with GPT4 prompt.</summary>
                  <TextField
                    label="Prompt"
                    variant="standard"
                    multiline
