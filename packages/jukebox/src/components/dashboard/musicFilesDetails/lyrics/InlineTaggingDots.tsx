...
const pattern =
  "(([あいうえおアイウエオゕゖヵヶ]|[かがさざただなはばぱまやらわカガサザタダナハバパマヤラワヷ][あア]*|[きぎしじちぢにひびぴみりゐキギシジチヂニヒビピミリヰヸ]([いイゃャ]|[ゅょュョ][うウ]?)*|[くぐすずつづぬふぶぷむゆるゔクグスズツヅヌフブプムユルヴ][うウ]*|[けげせぜてでねへべぺめれゑケゲセゼテデネヘベペメレヱヹ][いイ]*|[こごそぞとどのほぼぽもよろをコゴソゾトドノホボポモヨロヲヺ][うウ]*)[ぁぃぅぇぉっァィゥェォッー]*|\\p{sc=Han}|[\\p{sc=Latin}\\p{sc=Cyrillic}\\p{sc=Greek}]+)";
