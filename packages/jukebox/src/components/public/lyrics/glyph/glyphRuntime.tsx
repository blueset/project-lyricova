 ...
 *
 * Re-exported so renderers have a single import for the shared shaping config;
 * see {@link ../glyph/fontVariations.ts} for why `opsz` tracks the font size.
 */
export { glyphVariations } from "./fontVariations";
